...
\begin{remark}
    The content of this chapter is an extended and revised version
    of~\cite[Sec. 4]{ghica2024fully}.
\end{remark}

\input{sections/circuits/operational/feedback}
\input{sections/circuits/operational/productivity}
\input{sections/circuits/operational/observational}