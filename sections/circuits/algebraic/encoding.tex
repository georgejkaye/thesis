...
terms of smaller components; first we show some lemmas.
...
Since the encoders, decoders, and core are essentially combinational, these can
be normalised once again to obtain a new normalised core.