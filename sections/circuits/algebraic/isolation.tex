...
\begin{lemma}\label{lem:isolate-outputs}
    In a Cartesian category, \(
        \iltikzfig{strings/category/f-1-2}[box=F,colour=white,dom=m,cod1=x,cod2=n]
        =
        \iltikzfig{circuits/truth-tables/isolate}[box=F,colour=white,cod1=x,cod2=n]
    \).
\end{lemma}
\begin{proof}
    \(
        \iltikzfig{strings/category/f-1-2}[box=F,colour=white,dom=m,cod2=n]
        \eqaxioms[(\monoidunitleqn,\monoidunitreqn)]
        \iltikzfig{circuits/truth-tables/isolate-step-1}[box=F,colour=white,dom=m,cod=n]
        \eqaxioms[(\cartnatcopyeqn)]
        \iltikzfig{circuits/truth-tables/isolate}[box=F,colour=white,dom=m,cod2=n]
    \)
\end{proof}
...
\begin{lemma}\label{lem:normalised-mealy}
