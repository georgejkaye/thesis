...
The first ensures that all the sources and targets of a hyperedges are present
...
In the above example, all of the rewrites other than the first were `hidden'
...
Given a DPO rule and matching, we can enumerate all the possible pushout
complements; it can be shown that each of these pushout complements correspond
