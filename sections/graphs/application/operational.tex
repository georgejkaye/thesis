...
\begin{example}\label{ex:sr-latch-instant-feedback-graph}
    ...
    \begin{center}
        \begin{tikzcd}[bezier bounding box=true, column sep=tiny]
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/inputs}}
            \arrow{r}
            &
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/instant-feedback}}
            &
            \arrow{l}
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/outputs}}
        \end{tikzcd}
    \end{center}
\end{example}
...
\begin{example}\label{ex:sr-latch-streaming-graph}
    ...
    \begin{center}
        \begin{tikzcd}[bezier bounding box=true, column sep=tiny]
            ...
            \arrow{r}
            &
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/applied}}
            &
            \arrow{l}
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/outputs}}
        \end{tikzcd}
    ...
    \begin{center}
        \begin{tikzcd}[bezier bounding box=true, column sep=tiny]
            ...
            \arrow{r}
            &
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/streamed}}
            &
            \arrow{l}
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/outputs}}
        \end{tikzcd}
...
\begin{figure}
    ...
    \quad
    \scalebox{0.8}{\includestandalone{figures/graphs/circuits/fork-rewrite/rule}}
    \\
    \scalebox{0.8}{\includestandalone{figures/graphs/circuits/join/rule}}
    \quad
    \scalebox{0.8}{\includestandalone{figures/graphs/circuits/stub/rule}}
...
\begin{example}
    ...
    \begin{center}
        \begin{tikzcd}[bezier bounding box=true, column sep=tiny]
            ...
            \arrow{r}
            &
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/values-1}}
            &
            \arrow{l}
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/outputs}}
        \end{tikzcd}
    ...
    \begin{center}
        \begin{tikzcd}[bezier bounding box=true, column sep=tiny]
            ...
            \arrow{r}
            &
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/values-2}}
            &
            \arrow{l}
            \scalebox{0.8}{\iltikzfig{graphs/circuits/sr-latch/outputs}}
        \end{tikzcd}
