...
\begin{definition}[Composition of cospans]
    ...
    In a category \(\mcc\) with pushouts, the composition of two cospans
    \(\cospan{X}[f]{A}[g]{Y}\) and \(\cospan{Y}[h]{B}[k]{Z}\), their composition
    is by pushout:
    \begin{center}
...
\begin{definition}[Categories of cospans~\cite{benabou1967introduction}]
    Let \(\mcc\) be a category with pushouts and a terminal object.
