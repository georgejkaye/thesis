...
The partial monogamy condition works exactly the same for coloured cospans, so
the partial monogamous cospans of coloured hypergraphs form a traced category.
