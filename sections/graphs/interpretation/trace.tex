...
\begin{corollary}[\cite{bonchi2022string}, Cor. 4.3]
    \label{cor:tohyp-faithful}
    \(\morph{\termtohypsigmac}{\smcsigmac}{\cspdchyp}\) is faithful.
\end{corollary}
\begin{proof}
    \todo[inline]{Sketch out proof}
\end{proof}

\begin{proposition}
    There exists a faithful PROP morphism \(
        \morph{\tracedtosymandfrobsigmas}{\stmc{\Sigma}}{\smc{\Sigma} + \frobc}
    \).
\end{proposition}
\begin{proof}
