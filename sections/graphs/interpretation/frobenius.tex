...
\begin{definition}
    ...
    discrete coloured hypergraph containing an appropriately coloured node for
...
\begin{example}\label{ex:frobenius-composite}
    ...
    By following the node maps, one can verify that this is indeed isomorphic
...
\begin{example}
    ...
    \]
    All of the Frobenius structure collapses into one node, much like when we
...
\begin{proof}
    ...
    components of the composite cospan now have appropriately coloured nodes.
\end{proof}