...
The lower equation (also known as the \emph{pentagon equation}) demonstrates
how composite symmetries can be created from the primitive ones.
For example, the composite symmetry \(
    \morph{\swap{A}{B \tensor C}}{A \tensor (B \tensor C)}{(B \tensor C) \tensor A}
\) is defined to be \(
