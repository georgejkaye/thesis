...
\begin{definition}[Term]
    ...
    \begin{center}
        ...
        \begin{bprooftree}
            \AxiomC{\(\morph{f}{\overline{m}}{\overline{n}} \in \generators_\mathsf{t}\)}
            \AxiomC{\(\morph{g}{\overline{n}}{\overline{p}} \in \generators_\mathsf{t}\)}
            \BinaryInfC{\(\morph{f \seq g}{\overline{m}}{\overline{p}} \in \generators_\mathsf{t}\)}
        \end{bprooftree}
        \begin{bprooftree}
            \AxiomC{\(\morph{f}{\overline{m}}{\overline{n}} \in \generators_\mathsf{t}\)}
            \AxiomC{\(\morph{g}{\overline{p}}{\overline{q}} \in \generators_\mathsf{t}\)}
            \BinaryInfC{\(
                \morph{f \tensor g}{\overline{m} \concat \overline{p}}{\overline{n} \concat \overline{q}} \in \generators_\mathsf{t}
            \)}
        \end{bprooftree}
    \end{center}
\end{definition}
