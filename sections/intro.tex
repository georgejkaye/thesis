...
Large term can be built up compositionally in this way, but the one-dimensional
...
These works operate in a setting with a \emph{Frobenius} structure: a particular
interaction of a commutative monoid and a cocommutative comonoid.
In such a setting, feedback is constructed from primitive components:
\[
...
\todo[inline]{Traced vs compact closed}
...
Along the way, we also define a category of Mealy machines \(\mealyi\) lifted to
