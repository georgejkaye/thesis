...
\begin{definition}[Functor category]\index{category!functor category}\index{functor!category}
...
\begin{example}[Singleton transformation]\index{natural transforamtion!singleton}
...
\begin{example}[Reduce]\index{natural transformation!reduce}
...
\begin{definition}[Natural isomorphism]
    \index{natural transformation!isomorphism}\index{natural isomorphism}
