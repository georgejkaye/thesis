...
Fortunately, terms have an graphical syntax known as \emph{string diagrams} that
...
\begin{example}\label{ex:term-diagrams}
    ...
    \end{gather*}
    While each term has a very different text string, and is tiled differently
    in each diagram, the connectivity of the thick wires is actually the same!
\end{example}
