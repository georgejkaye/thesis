...
\begin{example}[Free monoid]\label{ex:free-monoid}\index{free monoid}\index{functor!free monoid}
    ...
    There is also a \emph{forgetful} or \emph{underlying} functor\index{functor!forgetful functor}
...
\begin{definition}[Faithful functor~\cite{maclane1978categories}]\index{functor!faithful}
...
\begin{definition}[Full functor~\cite{maclane1978categories}]\index{functor!full}
...
\begin{definition}[Subcategory]\index{category!subcategory}
...
\begin{definition}[Full subcategory]\index{category!full subcategory}
...
\begin{definition}[Cocomplete category]\index{category!cocomplete category}
