...
The minimum element of such an ordered set of values represents a complete
...
inputs to a primitive are \(\bot\), then it should produce \(\bot\); we cannot
produce information from nothing.
...
functions; indeed, this is the strategy in~\cite{ghica2024fully}.
