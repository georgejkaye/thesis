...
\begin{definition}
    \index{Mealy!functions!generalised}
...
\begin{definition}
    \index{encoding equations!generalised}
...
\begin{definition}
    \index{restriction equation!generalised}
...
\begin{definition}
    \index{s@\(\scircsigmage\)}
    \nomenclature{\(\scircsigmage\)}{PROP of generalised sequential circuits quotiented by equations}
