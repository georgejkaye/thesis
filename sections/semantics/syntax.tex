...
\begin{definition}[Combinational circuit generators]
    ...
    \nomenclature{\(\ccircsigma\)}{category of combinational circuits}
\end{definition}
...
\begin{definition}[Sequential circuits]\index{sequential circuits}\index{sequential}
    \nomenclature{\(\scircsigma\)}{category of sequential circuits}
...
\begin{definition}
    \index{\(\ccircsigmag\)}
    \nomenclature{\(\ccircsigmag\)}{category of generalised combinational circuits}
...
\begin{definition}
    \index{s@\(\scircsigmag\)}
    \nomenclature{\(\scircsigmag\)}{category of generalised sequential circuits}
    For a generalised circuit signature \(\circuitsignature\), let the set
    \(\generators[\scirc{}^+]\) of
