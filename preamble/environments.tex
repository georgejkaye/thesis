...
\ifthenelse{\boolean{shade-envs}}{%
    ...
    \colourbox{theorem}{ShadeOfPurple}
    \colourbox{lemma}{ShadeOfPurple}
    \colourbox{proposition}{ShadeOfPurple}
    \colourbox{corollary}{ShadeOfPurple}
    \colourbox{definition}{ShadeOfYellow}
    \colourbox{notation}{ShadeOfYellow}
    \colourbox{example}{ShadeOfGreen}
    \colourbox{remark}{ShadeOfBrown}
    \colourbox{proof}{ShadeOfGray}
}{
